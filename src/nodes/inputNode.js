    ...
    <div className="bg-gradient-to-br from-violet-50 to-purple-50 shadow-lg border border-violet-200 p-4 rounded-xl min-w-72 max-w-72 transition-all duration-300 hover:shadow-xl">
      ...
      <div className="space-y-4">
        <label className="flex flex-col space-y-2">
          ...
          {inputType === 'Text' ? (
            <textarea 
              className=" w-full px-4 py-2 rounded-lg bg-white border border-violet-200 focus:border-violet-400 focus:ring-2 focus:ring-violet-200 outline-none transition-all duration-200 placeholder-violet-300 resize-y "
              value={currName} 
